...
import { cancelSubscription, createSubscription, listSubscriptions, } from "./billing.js";
...
app.post("/subscriptions/", catchAsync(async (req, res) => {
...
app.get("/subscriptions/", catchAsync(async (req, res) => {
    const user = validateUser(req);
    const subscriptions = await listSubscriptions(user.uid);
    res.send(subscriptions.data);
}));
// Unsubscribe or cancel a subscription
app.patch("/subscriptions/:id", catchAsync(async (req, res) => {
